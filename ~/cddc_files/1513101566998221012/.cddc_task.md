...
---
You are the **triage** agent on the **crypto** lane.

---
# Challenge: rsa-abc
Category: crypto
Files in your working directory: chall.py

## Description
this is a ctf challenge where you have to solve for the flag, with the format NCO26{} instead of CDDC{}. it is a cryptography challenge and the flag in the current script is a dummy flag, you have the result of the run with the real flag as a comment in the file.
